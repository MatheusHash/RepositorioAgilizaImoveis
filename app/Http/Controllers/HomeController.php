...
class HomeController extends Controller
{
    ...
    public function alugar(){
        ...
        $bairros = Cidade::where('isCidade',null)->orderBy('nome','asc')->get();
        $categorias = Categoria::all();
        return view('imoveis.index',['motivo'=>1,'imoveis'=>$imoveis,'cidades'=>$cidades,'bairros'=>$bairros,'categorias'=>$categorias]);
    }

    public function comprar(){
        $imoveis = Imovel::where('motivo',2)->where('visibility',1)
                            ->orWhere(function($query){
                            $query->where('motivo',3);
        })->get();
        ...
        $bairros = Cidade::where('isCidade',null)->orderBy('nome','asc')->get();
        $categorias = Categoria::all();
        return view('imoveis.index',['motivo'=>2,'imoveis'=>$imoveis,'cidades'=>$cidades,'bairros'=>$bairros,'categorias'=>$categorias]);
    }
    ...
    public function imoveisFiltradosPelaHome(FiltroBuscaRequest $request){
        ...
        $bairros = Cidade::where('isCidade',null)->orderBy('nome','asc')->get();
        $categorias = Categoria::all();
        return view('imoveis.index',['motivo'=>$request->motivo,'imoveis'=>$imoveis,'cidades'=>$cidades,'bairros'=>$bairros,'categorias'=>$categorias]);
    }
